...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/meganquintana/src/shopping-site/shopping-site-env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/meganquintana/src/shopping-site/shopping-site-env/bin/deactivate.nu'
